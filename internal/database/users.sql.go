...
type SetUserRedParams struct {
	IsChirpyRed bool
	ID          uuid.UUID
}

func (q *Queries) SetUserRed(ctx context.Context, arg SetUserRedParams) error {
	_, err := q.db.ExecContext(ctx, setUserRed, arg.IsChirpyRed, arg.ID)
	return err
}
